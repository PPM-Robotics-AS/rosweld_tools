...
class NotifyTask(ITask):
    def __init__(self, type, progress, desc, title, step, message, level):
        super(NotifyTask, self).__init__(type, progress, desc, title)
        self.message = message
        self.level = level

    def play(self):
        super(NotifyTask, self).play()

    def pause(self):
        super(NotifyTask, self).pause()

    def reset(self):
        super(NotifyTask, self).reset()
