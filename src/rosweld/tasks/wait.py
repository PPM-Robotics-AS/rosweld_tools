...
class WaitTask(ITask):
    def __init__(self, type, progress, desc, title, step, timeout=None):
        super(WaitTask, self).__init__(type, progress, desc, title)
    ...
    def play(self):
        super(WaitTask, self).play()

    def pause(self):
        super(WaitTask, self).pause()

    def reset(self):
        super(WaitTask, self).reset()
